...
@interface CTInputEmoticon : NSObject
@property (nonatomic,strong)    NSString    *emoticonID;
@property (nonatomic,strong)    NSString    *tag;
@property (nonatomic,strong)    NSString    *filename;
@end

@interface CTInputEmoticonLayout : NSObject
...
@interface CTInputEmoticonCatalog : NSObject
@property (nonatomic,strong)    CTInputEmoticonLayout *layout;
...
@interface CTInputEmoticonManager : NSObject
