...
typedef NS_ENUM(NSInteger, LLDynamicModelType) {
    LLDynamicModelTypeText = 0,              //文字
    LLDynamicModelTypeRecord,                 //语音
    LLDynamicModelTypePicture,              //图片
    LLDynamicModelTypeVideo,       //视频
};

@interface LLDynamicModel : BaseObject
///动态id
