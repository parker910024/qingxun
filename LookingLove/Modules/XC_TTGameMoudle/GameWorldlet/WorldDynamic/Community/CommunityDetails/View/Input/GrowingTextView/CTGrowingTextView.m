...
@interface CTGrowingTextView()<UITextViewDelegate>
...
@implementation CTGrowingTextView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        CTGrowingInternalTextView *textView = [[CTGrowingInternalTextView alloc] initWithFrame:rect];
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        CTGrowingInternalTextView *textView = [[CTGrowingInternalTextView alloc] initWithFrame:CGRectZero];
        self.textView = textView;
...
@implementation CTGrowingTextView(TextView)
