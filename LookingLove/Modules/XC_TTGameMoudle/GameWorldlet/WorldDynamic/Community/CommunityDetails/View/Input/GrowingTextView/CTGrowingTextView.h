...
@class CTGrowingInternalTextView;
...
- (void)textViewDidBeginEditing:(CTGrowingTextView *)growingTextView;

- (void)textViewDidChangeSelection:(CTGrowingTextView *)growingTextView;
...
- (BOOL)textViewShouldEndEditing:(CTGrowingTextView *)growingTextView;
...
@interface CTGrowingTextView : UIScrollView

@property (nonatomic,weak) id<CTGrowingTextViewDelegate> textViewDelegate;
...
@property (nonatomic,strong) CTGrowingInternalTextView *textView;


@end

@interface CTGrowingTextView(TextView)
