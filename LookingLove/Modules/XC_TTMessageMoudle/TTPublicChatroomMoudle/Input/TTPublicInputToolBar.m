...
@interface TTPublicInputToolBar ()
<
...
@implementation TTPublicInputToolBar
...
- (void)onEmojiButtonClick:(UIButton *)sender {
...
@implementation TTPublicInputToolBar(InputText)
...
- (void)setEnable:(BOOL)isEnable {
    ...
    self.atButton.enabled = isEnable;
}
