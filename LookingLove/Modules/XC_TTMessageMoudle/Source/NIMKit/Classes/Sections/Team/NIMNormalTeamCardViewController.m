    ...
    if (selectedContacts.count) {
        ...
        switch (self.currentOpera) {
            case CardHeaderOpeatorAdd:{
                ...
                [[NIMSDK sharedSDK].teamManager addUsers:selectedContacts toTeam:self.team.teamId postscript:@"邀请你加入讨论组" attach:nil completion:^(NSError * _Nullable error, NSArray<NIMTeamMember *> * _Nullable members) {
