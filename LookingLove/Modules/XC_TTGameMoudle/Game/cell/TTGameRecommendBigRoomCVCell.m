//
//  TTGameRecommendBigRoomCVCell.m
//  TTPlay
//
...
@interface TTGameRecommendBigRoomCVCell ()
...
@implementation TTGameRecommendBigRoomCVCell
...
- (void)updateConstraint {
    ...
    UIBezierPath *coverPath = [UIBezierPath bezierPathWithRoundedRect:_coverImageView.bounds byRoundingCorners:UIRectCornerAllCorners cornerRadii:CGSizeMake(16, 16)];
    CAShapeLayer *coverLayer = [CAShapeLayer layer];
    
    coverLayer.path = coverPath.CGPath;
    _coverImageView.layer.mask = coverLayer;
