...
@class TTVoiceCardView;
typedef NS_ENUM(NSInteger, JCCardViewSwipeDirection) {
    TTVoiceCardViewSwipeDirectionLeft = -1,
    TTVoiceCardViewSwipeDirectionNone = 0,
    TTVoiceCardViewSwipeDirectionRight = 1
};

typedef __kindof UIView * _Nullable (^JCCardViewGetItemViewBlock)(TTVoiceCardView *cardView, NSInteger idx);
typedef void (^JCCardViewItemOptionBlock)(TTVoiceCardView *cardView, __kindof UIView *itemView, NSInteger idx);
typedef BOOL (^JCCardViewCanAnimationBlock)(TTVoiceCardView *cardView, __kindof UIView *itemView, NSInteger idx, JCCardViewSwipeDirection direction);
typedef void (^JCCardViewItemHandleBlock)(TTVoiceCardView *cardView, __kindof UIView *itemView, NSInteger idx, JCCardViewSwipeDirection direction);
typedef void (^JCCardViewProgressingBlock)(TTVoiceCardView *cardView, __kindof UIView *itemView, NSInteger idx, CGFloat progress);

@interface TTVoiceCardView : UIView
