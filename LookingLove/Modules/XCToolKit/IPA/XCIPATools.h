...
@protocol XCIPAToolsDelegate<NSObject>
@optional
/**
 *  代理：系统错误
 */
 ...
 *  @param productID 商品ID
 */
-(void)IAPToolBeginCheckingdWithProductID:(NSString *)productID receipt:(NSData *)receipt;
...
@interface XCIPATools : NSObject

/**
 *  代理
 */
@property(nonatomic,assign) id <XCIPAToolsDelegate> delegate;
/**
