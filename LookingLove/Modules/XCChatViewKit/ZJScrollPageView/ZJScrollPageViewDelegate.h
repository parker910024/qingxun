...
/**
 ...
 @param scrollView
 */
- (void)scrollPageControllerDidScroll:(UIScrollView *)scrollView;

- (void)scrollPageControllerWillBeginDragging:(UIScrollView *)scrollView;

- (void)scrollPageControllerDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate;
/** 滚动减速完成时再更新title的位置 */
- (void)scrollPageControllerDidEndDecelerating:(UIScrollView *)scrollView;
