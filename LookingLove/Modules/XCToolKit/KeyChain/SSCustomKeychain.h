...
typedef enum {
	/** No error. */
    SSCustomKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
    SSCustomKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
    SSCustomKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
    SSCustomKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
    SSCustomKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
    SSCustomKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
    SSCustomKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
    SSCustomKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
    SSCustomKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
    SSCustomKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
    SSCustomKeychainErrorFailedToDecode = errSecDecode
} SSCustomKeychainErrorCode;

extern NSString *const kSSCustomKeychainErrorDomain;

/** Account name. */
extern NSString *const kSSCustomKeychainAccountKey;
 ...
 */
extern NSString *const kSSCustomKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kSSCustomKeychainClassKey;

/** Item description. */
extern NSString *const kSSCustomKeychainDescriptionKey;

/** Item label. */
extern NSString *const kSSCustomKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kSSCustomKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kSSCustomKeychainWhereKey;
...
/**
 ...
 SSCustomKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface SSCustomKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in SSCustomKeychain.h for a list of keys that can be used when accessing the
