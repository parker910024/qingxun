...
@protocol TTFriendListViewControllerDelegate <NSObject>
...
@interface TTFriendListViewController : BaseTableViewController<ZJScrollPageViewChildVcDelegate>
@property (nonatomic, assign) BOOL isReload;

/** 选择过的人*/
@property (nonatomic, strong) NSMutableDictionary * selectDic;
/** 是不是选择的 如果不是不需要遵循此代理*/
@property (nonatomic, assign)id<TTFriendListViewControllerDelegate> delegate;
