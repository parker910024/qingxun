...
const char xc_zip_copyright[] = " zip 1.01 Copyright 1998-2004 Gilles Vollant - http://www.winimage.com/zLibDll";
    ...
    zlib_filefunc64_32_def *pzlib_filefunc64_32_def)
{
    ...
    if (pzlib_filefunc64_32_def == NULL)
        xc_fill_fopen64_filefunc(&ziinit.z_filefunc.zfile_func64);
    else
    {
...
extern zipFile ZEXPORT xc_zipOpen2(const char *path, int append, const char **globalcomment,
...
extern zipFile ZEXPORT xc_zipOpen2_64(const void *path, int append, const char **globalcomment,
...
extern zipFile ZEXPORT xc_zipOpen3(const char *path, int append, uint64_t disk_size, const char **globalcomment,
    zlib_filefunc_def *pzlib_filefunc32_def)
{
    if (pzlib_filefunc32_def != NULL)
    {
...
extern zipFile ZEXPORT xc_zipOpen(const char *path, int append)
{
    return xc_zipOpen3((const void*)path, append, 0, NULL, NULL);
}

extern zipFile ZEXPORT xc_zipOpen64(const void *path, int append)
{
    return xc_zipOpen3(path, append, 0, NULL, NULL);
}
...
extern int ZEXPORT xc_zipOpenNewFileInZip4_64(zipFile file, const char *filename, const zip_fileinfo *zipfi,
...
extern int ZEXPORT xc_zipOpenNewFileInZip4(zipFile file, const char *filename, const zip_fileinfo *zipfi,
    const void *extrafield_local, uint16_t size_extrafield_local, const void *extrafield_global,
...
{
    return xc_zipOpenNewFileInZip4_64(file, filename, zipfi, extrafield_local, size_extrafield_local,
...
extern int ZEXPORT xc_zipOpenNewFileInZip3(zipFile file, const char *filename, const zip_fileinfo *zipfi,
    const void *extrafield_local, uint16_t size_extrafield_local, const void *extrafield_global,
    uint16_t size_extrafield_global, const char *comment, uint16_t method, int level, int raw, int windowBits,
...
extern int ZEXPORT xc_zipOpenNewFileInZip3_64(zipFile file, const char *filename, const zip_fileinfo *zipfi,
    const void *extrafield_local, uint16_t size_extrafield_local, const void *extrafield_global,
    uint16_t size_extrafield_global, const char *comment, uint16_t method, int level, int raw, int windowBits,
...
extern int ZEXPORT xc_zipOpenNewFileInZip2(zipFile file, const char *filename, const zip_fileinfo *zipfi,
    const void *extrafield_local, uint16_t size_extrafield_local, const void *extrafield_global,
...
extern int ZEXPORT xc_zipOpenNewFileInZip2_64(zipFile file, const char *filename, const zip_fileinfo *zipfi,
    const void *extrafield_local, uint16_t size_extrafield_local, const void *extrafield_global,
...
extern int ZEXPORT xc_zipOpenNewFileInZip64(zipFile file, const char *filename, const zip_fileinfo *zipfi,
    const void *extrafield_local, uint16_t size_extrafield_local, const void *extrafield_global,
...
extern int ZEXPORT xc_zipOpenNewFileInZip(zipFile file, const char *filename, const zip_fileinfo *zipfi,
    const void *extrafield_local, uint16_t size_extrafield_local, const void *extrafield_global,
...
extern int ZEXPORT xc_zipWriteInFileInZip(zipFile file, const void *buf, uint32_t len)
{
    zip64_internal *zi = NULL;
    int err = ZIP_OK;
...
extern int ZEXPORT xc_zipCloseFileInZipRaw64(zipFile file, uint64_t uncompressed_size, uint32_t crc32)
{
    zip64_internal *zi = NULL;
...
extern int ZEXPORT xc_zipCloseFileInZipRaw(zipFile file, uint32_t uncompressed_size, uint32_t crc32)
{
    return xc_zipCloseFileInZipRaw64(file, uncompressed_size, crc32);
}

extern int ZEXPORT xc_zipCloseFileInZip(zipFile file)
{
    return xc_zipCloseFileInZipRaw(file, 0, 0);
}

extern int ZEXPORT xc_zipClose(zipFile file, const char *global_comment)
{
