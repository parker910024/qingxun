...
//    NSLog(@"old ---- %ld current --- %ld", _oldIndex, _currentIndex);
    ...
    if ([_delegate respondsToSelector:@selector(scrollPageControllerDidScroll:)]) {
        [_delegate scrollPageControllerDidScroll:scrollView];
    }
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(scrollPageControllerDidEndDecelerating:)]) {
        [_delegate scrollPageControllerDidEndDecelerating:scrollView];
    }
}
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(scrollPageControllerWillBeginDragging:)]) {
        [_delegate scrollPageControllerWillBeginDragging:scrollView];
    }
}
...
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate {
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(scrollPageControllerDidEndDragging:willDecelerate:)]) {
        [_delegate scrollPageControllerDidEndDragging:scrollView willDecelerate:decelerate];
    }
}
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
    ...
    if([view isKindOfClass:[UISlider class]]) {
        ...
        self.collectionView.scrollEnabled = self.segmentView.segmentStyle.isScrollContentView;
    }
    return view;
}
