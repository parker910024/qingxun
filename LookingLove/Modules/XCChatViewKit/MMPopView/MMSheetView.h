...
typedef enum : NSUInteger {
    MMSheetViewStyleNormal, //普通样式
    MMSheetViewStyleCornerRadius, //带圆角，padding
} MMSheetViewStyle;
...
@property (nonatomic, assign) CGFloat padding;              // Default is 10.  add by KevinWang
@property (nonatomic, assign) CGFloat cornerRadius;         // Default is 5.   add by KevinWang
