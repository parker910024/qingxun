...
void xc_fill_fopen_filefunc(zlib_filefunc_def *pzlib_filefunc_def);
void xc_fill_fopen64_filefunc(zlib_filefunc64_def *pzlib_filefunc_def);
...
voidpf   xc_call_zopen64(const zlib_filefunc64_32_def *pfilefunc,const void*filename, int mode);
voidpf   call_zopendisk64(const zlib_filefunc64_32_def *pfilefunc, voidpf filestream, uint32_t number_disk, int mode);
long     xc_call_zseek64(const zlib_filefunc64_32_def *pfilefunc, voidpf filestream, uint64_t offset, int origin);
uint64_t xc_call_ztell64(const zlib_filefunc64_32_def *pfilefunc, voidpf filestream);

void xc_fill_zlib_filefunc64_32_def_from_filefunc32(zlib_filefunc64_32_def *p_filefunc64_32, const zlib_filefunc_def *p_filefunc32);

#define ZOPEN64(filefunc,filename,mode)             (xc_call_zopen64((&(filefunc)),(filename),(mode)))
#define ZOPENDISK64(filefunc,filestream,diskn,mode) (call_zopendisk64((&(filefunc)),(filestream),(diskn),(mode)))
#define ZTELL64(filefunc,filestream)                (xc_call_ztell64((&(filefunc)),(filestream)))
#define ZSEEK64(filefunc,filestream,pos,mode)       (xc_call_zseek64((&(filefunc)),(filestream),(pos),(mode)))
