//
//  TTWorldletGroupFullAlertView.m
//  XC_TTGameMoudle
//
...
@interface TTWorldletGroupFullAlertView ()
...
@implementation TTWorldletGroupFullAlertView
...
- (UILabel *)contentLabel {
    if (!_contentLabel) {
        ...
        _contentLabel.text = @"哎呀，群聊人满暂时加不进来啦~";
    }
...
- (UIButton *)enterButton {
    if (!_enterButton) {
        ...
        [_enterButton setTitle:@"知道了" forState:UIControlStateNormal];
...
- (UIButton *)cancelButton {
    if (!_cancelButton) {
        ...
        [_cancelButton setTitle:@"不要灰心，群聊会定期腾出空位置哦~" forState:UIControlStateNormal];
