    ...
    [unzipQueue addOperationWithBlock:^{
        ...
        if (data != nil) {
            ...
            if ([cacheDir isKindOfClass:[NSString class]]) {
                ...
                [XCSSZipArchive unzipFileAtPath:tmpPath toDestination:[self cacheDirectory:cacheKey] progressHandler:^(NSString * _Nonnull entry, unz_file_info zipInfo, long entryNumber, long total) {
