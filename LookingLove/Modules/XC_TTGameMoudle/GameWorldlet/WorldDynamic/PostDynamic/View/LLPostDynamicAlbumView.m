...
static NSInteger const kPicMaxCount = 9; // 照片最多选择9张
static CGFloat const kMargin = 20.f; // 间距
static CGFloat const kPadding = 10.f; // 间距

#define itemWidth (KScreenWidth - kMargin * 2 - kPadding * 2) / 3 // item 宽度

@interface LLPostDynamicAlbumView ()
<
...
@implementation LLPostDynamicAlbumView
...
/// 显示数量，最多显示九张图，少于九张图时显示添加图片按钮
- (NSInteger)itemCount {
    NSInteger maxCount = 9;
    return self.dataArray.count >= maxCount ? maxCount : self.dataArray.count + 1;
}
